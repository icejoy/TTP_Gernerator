...
public abstract class NeuralNetworkTrainer
{
	...
	/**
	 * This contains the outer layers of the neural network First dimension is
	 * the vocab, second is the layer
	 */
	final double[][] syn0;
	...
	abstract class Worker extends CallableVoid
	{
		...
		public void run() throws InterruptedException
		{
			for (List<String> sentence : batch)
			{
				...
				// Turns out if you don't do this, the produced word vectors
				// aren't as tasty
				wordCount++;
